...
public final class CatalogUtil {
  ...
  public static String version0(String json) {
    var tree = (ObjectNode) org.opentmf.commons.util.JacksonUtil.jsonToTree(json);
    tree.put(CatalogConstants.VERSION, "0");
    tree.put("lifecycleStatus", "In design");
    var validFor = org.opentmf.commons.util.JacksonUtil.getDefaultObjectMapper().createObjectNode();
